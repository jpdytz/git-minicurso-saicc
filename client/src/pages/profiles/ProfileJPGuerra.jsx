...
export default function ProfileJPGuerra() {
              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    Buenas, me chamo João Pedro Guerra, tenho 20 anos e faço parte da equipe do Laboratório de Hardware do C3, e atualmente tenho um projeto de pesquisa aberto na área de telemetria.
                    Canto pro meu tricolor, meu único amor.
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a href="https://github.com/jpdytz" className="font-normal text-yellow-500">
                      <GitHubIcon/>
                    </a>
                  </div>
                </div>
